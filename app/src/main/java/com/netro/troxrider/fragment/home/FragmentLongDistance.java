...
public class FragmentLongDistance extends Fragment {
    ...
    private void loadData(String country, String state, String city) {
        ...
        Query query = localData.whereEqualTo("order_status", "Approved")
                .whereEqualTo("order_type","Domestic")
                .whereNotEqualTo("sender_city",city)
                .orderBy("sender_city", Query.Direction.ASCENDING);
