...
import com.netro.troxrider.activity.PickedUpDetailsActivity;
...
public class FragmentPickedUpHistory extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Query query = localData.whereEqualTo("order_status", "Picked Up").whereEqualTo("assigned_rider_id",userID).orderBy("timestamp", Query.Direction.ASCENDING);
        ...
        adapter.setOnItemClickListener(new OrderDataAdapter.OnItemClickListener() {
            ...
            public void onItemClick(DocumentSnapshot documentSnapshot) {
                ...
                Intent intent = new Intent(getContext(), PickedUpDetailsActivity.class);
